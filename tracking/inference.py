...
class ExactInference(InferenceModule):
	...
	if noisyDistance == None:			#when ghost is captured noisydistance is zero, so we increment our jail counter
	...
	for p in self.legalPositions:
		newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, p))		#Getting the new distribution of ghost
